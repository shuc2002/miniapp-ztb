<template>
  <view class="refresh-box" :style="isTranform">
    <view class="refresh" :style="isZoom" :class="isEnd == 2 ? 'animation-small' : ''">
      <view class="refresh-word" v-if="isEnd == 0">松开刷新</view>
      <view class="refresh-cirle animation" v-if="isEnd == 1" />
    </view>
  </view>
</template>
