...
function getCandleToolTipData(o, e, r, n, d, t) {
  var x = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : {};
  var a = r.chartData.calPoints;
  let l = t.color.upFill;
  let s = t.color.downFill;
  let h = [l, l, s, l];
  var c = [];
  e.map(function (t) {
    if (n == 0) {
    ...
    let e = { text: '开盘：' + t.data[0], color: h[0] };
    let a = { text: '收盘：' + t.data[1], color: h[1] };
    let i = { text: '最低：' + t.data[2], color: h[2] };
    let r = { text: '最高：' + t.data[3], color: h[3] };
    c.push(e, a, i, r);
  });
  var i = [];
  var f = { x: 0, y: 0 };
  ...
  f.x = Math.round(i[0][0].x);
  return { textList: c, offset: f };
}
...
function calLegendData(l, s, e, t, h) {
  ...
  let p = 15 * s.pix;
  let u = 5 * s.pix;
  let g = Math.max(s.legend.lineHeight * s.pix, f);
  if (s.legend.position == 'top' || s.legend.position == 'bottom') {
    ...
    for (let a = 0; a < l.length; a++) {
      ...
      let e = p + u + measureText(y || 'undefined', f, h) + s.legend.itemGap * s.pix;
    ...
    if (n.length) {
      ...
      c.area.wholeHeight = i.length * g + 2 * d + 2 * x;
      c.points = i;
    }
  } else {
    let t = l.length;
    let e = s.height - s.area[0] - s.area[2] - 2 * x - 2 * d;
    let a = Math.min(Math.floor(e / g), t);
    ...
    if (r.length) {
      for (let t = 0; t < r.length; t++) {
        ...
        let i = 0;
        for (let e = 0; e < a.length; e++) {
          let t = p + u + measureText(a[e].name || 'undefined', f, h) + s.legend.itemGap * s.pix;
          if (t > i) {
            i = t;
          }
        }
...
function calCategoriesData(t, i, e, a, r) {
  var o = { angle: 0, xAxisHeight: e.xAxisHeight };
  var n = i.xAxis.fontSize * i.pix || e.fontSize;
  ...
  if (i.xAxis.rotateLabel == true) {
    ...
    if (i.enableScroll == true && i.xAxis.scrollShow == true) {
      t += 12 * i.pix;
    }
    o.xAxisHeight = t;
  }
...
function calXAxisData(t, e, a, i) {
  ...
  var o = { angle: 0, xAxisHeight: a.xAxisHeight };
...
function getGaugeDataPoints(i, r, o) {
  ...
  for (let a = 0; a < i.length; a++) {
    ...
    let t = o.startAngle - o.endAngle + 1;
...
function getMountDataPoints(t, o, n, l, s, h, e) {
  ...
  var a = h.width - h.area[1] - h.area[3];
...
function getStackDataPoints(t, s, h, c, u, d, e, x, y) {
  var f = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : 1;
  var p = [];
  var g = d.height - d.area[0] - d.area[2];
  t.forEach(function (t, e) {
    if (t === null) {
      p.push(null);
    } else {
...
function getBarStackDataPoints(t, s, h, c, e, d, a, x, u) {
  var f = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : 1;
  var p = [];
  var g = d.width - d.area[1] - d.area[3];
  t.forEach(function (t, e) {
    if (t === null) {
      p.push(null);
    } else {
  ...
  if (t > 0) {
    ...
    for (let r = 0; r < t; r++) {
      ...
      if (i.type === 'categories') {
        ...
        if (!i.formatter) {
          i.formatter = (t, e, a) => {
            return t.toFixed(i.tofix) + (i.unit || '');
          };
        }
...
function drawRingTitle(t, e, a, i) {
  ...
  if (l) {
    ...
    var g = i.x - p / 2 + (t.subtitle.offsetX || 0) * t.pix;
  ...
  if (n) {
    var u = measureText(n, r * t.pix, a);
    var y = i.x - u / 2 + (t.title.offsetX || 0);
...
function drawMountPointText(t, o, n, l, s) {
  var e = o.data;
  var h = o.textOffset ? o.textOffset : 0;
  t.forEach(function (t, e) {
    if (t !== null) {
      l.beginPath();
      var a = o[e].textSize ? o[e].textSize * s.pix : n.fontSize;
      l.setFontSize(a);
      l.setFillStyle(o[e].textColor || s.fontColor);
      var i = t.value;
      var r = o[e].formatter ? o[e].formatter(i, e, o, s) : i;
      l.setTextAlign('center');
...
function drawGaugeLabel(e, a, i, r, o, n) {
  ...
  a = a < 10 ? 10 : a;
  let t = e.startAngle - e.endAngle + 1;
  let d = t / e.splitLine.splitNumber;
  let x = e.endNumber - e.startNumber;
  let f = x / e.splitLine.splitNumber;
  let l = e.startAngle;
  let s = e.startNumber;
  for (let t = 0; t < e.splitLine.splitNumber + 1; t++) {
    var h = { x: a * Math.cos(l * Math.PI), y: a * Math.sin(l * Math.PI) };
    var c = e.formatter ? e.formatter(s, t, r) : s;
...
function drawMarkLine(s, h, c) {
  let e = assign({}, { type: 'solid', dashLength: 4, data: [] }, s.extra.markLine);
  let a = s.area[3];
  let i = s.width - s.area[1];
  let r = calMarkLineData(e.data, s);
  for (let t = 0; t < r.length; t++) {
    let l = assign(
      {},
      {
    ...
    c.setLineDash([]);
    if (l.showLabel) {
      let t = l.labelText ? l.labelText : l.value;
      c.setFontSize(h.fontSize);
      let e = measureText(t, h.fontSize, c);
      let a = e + h.toolTipPadding * 2;
      let i = l.labelAlign == 'left' ? s.area[3] - a : s.width - s.area[1];
      i += l.labelOffsetX;
      let r = l.y - 0.5 * h.fontSize - h.toolTipPadding;
      r += l.labelOffsetY;
      let o = i + h.toolTipPadding;
      let n = l.y;
...
function drawToolTipHorizentalLine(d, x, f, t, e) {
  var p = assign({}, { gridType: 'solid', dashLength: 4 }, d.extra.tooltip);
  var a = d.area[3];
  var i = d.width - d.area[1];
  if (p.gridType == 'dash') {
    f.setLineDash([p.dashLength, p.dashLength]);
  }
  f.setStrokeStyle(p.gridColor || '#cccccc');
  f.setLineWidth(1 * d.pix);
  f.beginPath();
  f.moveTo(a, d.tooltip.offset.y);
  f.lineTo(i, d.tooltip.offset.y);
  f.stroke();
  f.setLineDash([]);
  if (p.yAxisLabel) {
    let l = calTooltipYAxisData(d.tooltip.offset.y, d.series, d, x, t);
    let s = d.chartData.yAxisData.yAxisWidth;
    let h = d.area[3];
    let c = d.width - d.area[1];
    for (let n = 0; n < l.length; n++) {
      f.setFontSize(x.fontSize);
      let t = measureText(l[n], x.fontSize, f);
      let e, a, i;
      if (s[n].position == 'left') {
        e = h - s[n].width;
        a = Math.max(e, e + t + x.toolTipPadding * 2);
      } else {
        e = c;
        a = Math.max(e + s[n].width, e + t + x.toolTipPadding * 2);
      }
      i = a - e;
      let r = e + (i - t) / 2;
      let o = d.tooltip.offset.y;
      f.beginPath();
      f.setFillStyle(
        hexToRgb(p.labelBgColor || x.toolTipBackground, p.labelBgOpacity || x.toolTipOpacity)
      );
      f.setStrokeStyle(p.labelBgColor || x.toolTipBackground);
      f.setLineWidth(1 * d.pix);
      f.rect(e, o - 0.5 * x.fontSize - x.toolTipPadding, i, x.fontSize + 2 * x.toolTipPadding);
      f.closePath();
      f.stroke();
      f.fill();
      f.beginPath();
      f.setFontSize(x.fontSize);
      f.setFillStyle(p.labelFontColor || d.fontColor);
      f.fillText(l[n], r, o + 0.5 * x.fontSize);
      f.closePath();
      f.stroke();
      if (s[n].position == 'left') {
...
function drawToolTip(t, r, e, o, n, c, d) {
  ...
  var h = x + f + 4 * o.toolTipPadding + Math.max.apply(null, g);
  var a = 2 * o.toolTipPadding + t.length * o.toolTipLineHeight;
  if (l.showBox == false) {
    return;
  }
  ...
  t.forEach(function (t, e) {
    if (t.color !== null) {
      ...
      var a = r.x + s + 2 * o.toolTipPadding;
      var i =
        r.y +
      ...
      n.fillRect(a, i, x, o.fontSize);
      n.closePath();
    }
  });
  t.forEach(function (t, e) {
    var a = r.x + s + 2 * o.toolTipPadding + x + f;
    if (p) {
      a = r.x - h - s + 2 * o.toolTipPadding + +x + f;
    }
    var i =
...
function drawColumnDataPoints(y, v, m, T) {
  let b = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
  let t = v.chartData.xAxisData,
    P = t.xAxisPoints,
    w = t.eachSpacing;
  let S = assign(
    {},
  ...
  if (v._scrollDistance_ && v._scrollDistance_ !== 0 && v.enableScroll === true) {
    ...
    C = Math.floor(-v._scrollDistance_ / w) - 2;
    D = C + v.xAxis.itemCount + 4;
  }
  if (v.tooltip && v.tooltip.textList && v.tooltip.textList.length && b === 1) {
    drawToolTipSplitArea(v.tooltip.offset.x, v, m, T, w);
  }
  S.customColor = fillCustomColor(S.linearType, S.customColor, y, m);
  y.forEach(function (a, i) {
    let t, o, x;
    t = [].concat(v.chartData.yAxisData.ranges[a.index]);
    o = t.pop();
    x = t.shift();
    var f = a.data;
    switch (S.type) {
      case 'group':
        var r = getDataPoints(f, o, x, P, w, v, m, b);
        var p = getStackDataPoints(f, o, x, P, w, v, m, i, y, b);
        A.push(p);
        r = fixColumeData(r, w, y.length, i, m, v);
        for (let t = 0; t < r.length; t++) {
          let o = r[t];
          if (o !== null && t > C && t < D) {
            var n = o.x - o.width / 2;
            var l = v.height - o.y - v.area[2];
            T.beginPath();
            var s = o.color || a.color;
            var g = o.color || a.color;
            if (S.linearType !== 'none') {
              var e = T.createLinearGradient(n, o.y, n, v.height - v.area[2]);
            ...
            if (
              ...
              const c = o.y;
              const d = o.width;
              const l = v.height - v.area[2] - o.y;
              if (S.barBorderCircle) {
                S.barBorderRadius = [d / 2, d / 2, 0, 0];
              }
              let [t, e, a, i] = S.barBorderRadius;
              let r = Math.min(d / 2, l / 2);
              t = t > r ? r : t;
              e = e > r ? r : e;
              a = a > r ? r : a;
              i = i > r ? r : i;
              ...
              T.arc(h + d - a, c + l - a, a, 0, Math.PI / 2);
              T.arc(h + i, c + l - i, i, Math.PI / 2, Math.PI);
            } else {
              T.moveTo(n, o.y);
              T.lineTo(n + o.width, o.y);
              T.lineTo(n + o.width, v.height - v.area[2]);
              T.lineTo(n, v.height - v.area[2]);
              T.lineTo(n, o.y);
              T.setLineWidth(1);
              T.setStrokeStyle(g);
            }
        ...
        break;
      case 'stack':
        var r = getStackDataPoints(f, o, x, P, w, v, m, i, y, b);
        A.push(r);
        r = fixColumeStackData(r, w, y.length, i, m, v, y);
        for (let e = 0; e < r.length; e++) {
          ...
          if (t !== null && e > C && e < D) {
            ...
            var l = v.height - t.y - v.area[2];
            var u = v.height - t.y0 - v.area[2];
            if (i > 0) {
              l -= u;
            }
            T.setFillStyle(s);
            T.moveTo(n, t.y);
            T.fillRect(n, t.y, t.width, l);
            T.closePath();
            T.fill();
          }
        }
      ...
      case 'meter':
        var r = getDataPoints(f, o, x, P, w, v, m, b);
        A.push(r);
        r = fixColumeMeterData(r, w, y.length, i, m, v, S.meterBorder);
        for (let t = 0; t < r.length; t++) {
          let o = r[t];
          if (o !== null && t > C && t < D) {
            T.beginPath();
            if (i == 0 && S.meterBorder > 0) {
              T.setStrokeStyle(a.color);
              T.setLineWidth(S.meterBorder * v.pix);
            }
            if (i == 0) {
              T.setFillStyle(S.meterFillColor);
            } else {
              T.setFillStyle(o.color || a.color);
            }
            var n = o.x - o.width / 2;
            var l = v.height - o.y - v.area[2];
            if (
  ...
  if (v.dataLabel !== false && b === 1) {
    y.forEach(function (t, e) {
      ...
      switch (S.type) {
        case 'group':
          var n = getDataPoints(o, i, r, P, w, v, m, b);
          n = fixColumeData(n, w, y.length, e, m, v);
          drawPointText(n, t, m, T, v);
          break;
        case 'stack':
          var n = getStackDataPoints(o, i, r, P, w, v, m, e, y, b);
          drawPointText(n, t, m, T, v);
          break;
        case 'meter':
          var n = getDataPoints(o, i, r, P, w, v, m, b);
...
function drawMountDataPoints(i, n, o, l) {
  ...
  y = u.pop();
  v = u.shift();
  var h = getMountDataPoints(i, y, v, p, r, n, s, f);
  switch (s.type) {
    case 'bar':
      for (let t = 0; t < h.length; t++) {
        ...
        if (o !== null && t > a && t < g) {
          ...
          if (s.linearType !== 'none') {
            var x = l.createLinearGradient(c, o.y, c, n.height - n.area[2]);
            if (s.linearType == 'opacity') {
              x.addColorStop(0, hexToRgb(d, s.linearOpacity));
              x.addColorStop(1, hexToRgb(d, 1));
            } else {
          ...
          if ((s.barBorderRadius && s.barBorderRadius.length === 4) || s.barBorderCircle === true) {
            ...
            if (s.barBorderCircle) {
              s.barBorderRadius = [w / 2, w / 2, 0, 0];
            }
            let [t, e, a, i] = s.barBorderRadius;
            let r = Math.min(w / 2, m / 2);
            t = t > r ? r : t;
            e = e > r ? r : e;
            a = a > r ? r : a;
            i = i > r ? r : i;
            ...
            a = a < 0 ? 0 : a;
            i = i < 0 ? 0 : i;
            l.arc(b + t, P + t, t, -Math.PI, -Math.PI / 2);
            l.arc(b + w - e, P + e, e, -Math.PI / 2, 0);
            l.arc(b + w - a, P + m - a, a, 0, Math.PI / 2);
            l.arc(b + i, P + m - i, i, Math.PI / 2, Math.PI);
          } else {
            l.moveTo(c, o.y);
    ...
    case 'triangle':
      for (let e = 0; e < h.length; e++) {
        ...
        if (t !== null && e > a && e < g) {
          ...
          if (s.linearType !== 'none') {
            var x = l.createLinearGradient(c, t.y, c, n.height - n.area[2]);
            if (s.linearType == 'opacity') {
              x.addColorStop(0, hexToRgb(d, s.linearOpacity));
              x.addColorStop(1, hexToRgb(d, 1));
            } else {
  ...
  if (n.dataLabel !== false && f === 1) {
    let t, e, a;
    t = [].concat(n.chartData.yAxisData.ranges[0]);
    e = t.pop();
    a = t.shift();
    var h = getMountDataPoints(i, e, a, p, r, n, s, f);
...
function drawBarDataPoints(y, v, m, T) {
  ...
  y.forEach(function (a, t) {
    ...
    switch (S.type) {
      case 'group':
        var i = getBarDataPoints(x, e, d, P, w, v, m, b);
        var f = getBarStackDataPoints(x, e, d, P, w, v, m, t, y, b);
        A.push(f);
        ...
        for (let t = 0; t < i.length; t++) {
          ...
          if (o !== null && t > C && t < D) {
            ...
            if (S.linearType !== 'none') {
              ...
              if (S.linearType == 'opacity') {
                s.addColorStop(0, hexToRgb(l, S.linearOpacity));
                s.addColorStop(1, hexToRgb(l, 1));
              } else {
                s.addColorStop(0, hexToRgb(S.customColor[a.linearIndex], S.linearOpacity));
                s.addColorStop(
                  S.colorStop,
                  hexToRgb(S.customColor[a.linearIndex], S.linearOpacity)
                );
        ...
        break;
      case 'stack':
        var i = getBarStackDataPoints(x, e, d, P, w, v, m, t, y, b);
        A.push(i);
  ...
  if (v.dataLabel !== false && b === 1) {
    y.forEach(function (t, e) {
      ...
      switch (S.type) {
        case 'group':
          var n = getBarDataPoints(o, i, r, P, w, v, m, b);
          n = fixBarData(n, w, y.length, e, m, v);
          drawBarPointText(n, t, m, T, v);
          break;
        case 'stack':
          var n = getBarStackDataPoints(o, i, r, P, w, v, m, e, y, b);
          drawBarPointText(n, t, m, T, v);
          break;
      }
    });
  }
  return { yAxisPoints: P, calPoints: A, eachSpacing: w };
}
function drawCandleDataPoints(e, t, h, c, d) {
  var u = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 1;
  ...
  if (h._scrollDistance_ && h._scrollDistance_ !== 0 && h.enableScroll === true) {
    ...
    g = -h._scrollDistance_ - f * 2 + h.area[3];
    m = g + (h.xAxis.itemCount + 4) * f;
  }
  if (s.average.show || t) {
    t.forEach(function (e, t) {
      ...
      r = a.shift();
      var o = e.data;
      var n = getDataPoints(o, i, r, x, f, h, c, u);
  ...
  e.forEach(function (t, e) {
    ...
    r = a.shift();
    var o = t.data;
    var n = getCandleDataPoints(o, i, r, x, f, h, c, u);
    y.push(n);
...
function drawAreaDataPoints(t, s, h, c) {
  ...
  var x = assign(
    {},
    { type: 'straight', opacity: 0.2, addLine: false, width: 2, gradient: false },
    s.extra.area
  );
  let e = s.chartData.xAxisData,
    y = e.xAxisPoints,
    f = e.eachSpacing;
  let p = s.height - s.area[2];
  let v = [];
  c.save();
  let g = 0;
  let u = s.width + f;
  if (s._scrollDistance_ && s._scrollDistance_ !== 0 && s.enableScroll === true) {
    ...
    g = -s._scrollDistance_ - f * 2 + s.area[3];
    u = g + (s.xAxis.itemCount + 4) * f;
  }
  t.forEach(function (e, t) {
    let a, i, r;
    ...
    r = a.shift();
    let o = e.data;
    let n = getDataPoints(o, i, r, y, f, s, h, d);
    v.push(n);
    ...
    for (let t = 0; t < l.length; t++) {
      ...
      if (r.length > 1) {
        ...
        let t = r[0];
        c.moveTo(t.x - f / 2, t.y);
        c.lineTo(t.x + f / 2, t.y);
        c.lineTo(t.x + f / 2, p);
        c.lineTo(t.x - f / 2, p);
        c.moveTo(t.x - f / 2, t.y);
      }
  ...
  if (s.dataLabel !== false && d === 1) {
    t.forEach(function (t, e) {
      ...
      r = a.shift();
      var o = t.data;
      var n = getDataPoints(o, i, r, y, f, s, h, d);
      drawPointText(n, t, h, c, s);
    });
  }
  c.restore();
  return { xAxisPoints: y, calPoints: v, eachSpacing: f };
}
...
function drawBubbleDataPoints(l, s, h, c) {
  var d = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
  var x = assign({}, { opacity: 1, border: 2 }, s.extra.bubble);
  let t = s.chartData.xAxisData,
    f = t.xAxisPoints,
    p = t.eachSpacing;
  var e = [];
  c.save();
  ...
  l.forEach(function (t, e) {
    ...
    c.beginPath();
    c.setStrokeStyle(t.color);
    c.setLineWidth(x.border * s.pix);
    c.setFillStyle(hexToRgb(t.color, x.opacity));
    n.forEach(function (t, e) {
    ...
    if (s.dataLabel !== false && d === 1) {
      n.forEach(function (t, e) {
        c.beginPath();
        var a = l.textSize * s.pix || h.fontSize;
        c.setFontSize(a);
  ...
  c.restore();
  return { xAxisPoints: f, calPoints: e, eachSpacing: p };
}
function drawLineDataPoints(t, s, h, c) {
  var d = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
  var x = assign({}, { type: 'straight', width: 2 }, s.extra.line);
  x.width *= s.pix;
  let e = s.chartData.xAxisData,
    f = e.xAxisPoints,
    p = e.eachSpacing;
  ...
  c.restore();
  return { xAxisPoints: f, calPoints: y, eachSpacing: p };
}
function drawMixDataPoints(t, v, m, T) {
  ...
  let S = assign({}, { opacity: 0.2, gradient: false }, v.extra.mix.area);
  let M = v.height - v.area[2];
  let L = [];
  var _ = 0;
  var F = 0;
  t.forEach(function (t, e) {
  ...
  if (v._scrollDistance_ && v._scrollDistance_ !== 0 && v.enableScroll === true) {
    T.translate(v._scrollDistance_, 0);
    k = Math.floor(-v._scrollDistance_ / P) - 2;
    R = k + v.xAxis.itemCount + 4;
    A = -v._scrollDistance_ - P * 2 + v.area[3];
    C = A + (v.xAxis.itemCount + 4) * P;
  }
  ...
  t.forEach(function (n, t) {
    ...
    f = o.shift();
    var p = n.data;
    var a = getDataPoints(p, x, f, b, P, v, m, D);
    L.push(a);
    if (n.type == 'column') {
      a = fixColumeData(a, P, F, _, m, v);
      for (let t = 0; t < a.length; t++) {
        let o = a[t];
        if (o !== null && t > k && t < R) {
          var l = o.x - o.width / 2;
    ...
    if (n.type == 'area') {
      ...
      for (let t = 0; t < e.length; t++) {
        ...
        T.setStrokeStyle(hexToRgb(n.color, S.opacity));
        if (S.gradient) {
          let t = T.createLinearGradient(0, v.area[0], 0, v.height - v.area[2]);
          t.addColorStop('0', hexToRgb(n.color, S.opacity));
          t.addColorStop('1.0', hexToRgb('#FFFFFF', 0.1));
          T.setFillStyle(t);
        } else {
          T.setFillStyle(hexToRgb(n.color, S.opacity));
        }
        ...
        if (i.length > 1) {
          ...
          if (n.style === 'curve') {
            for (let e = 0; e < i.length; e++) {
              ...
              if (e > 0 && t.x > A && t.x < C) {
                var u = createCurveControlPoints(i, e - 1);
          ...
          let t = i[0];
          T.moveTo(t.x - P / 2, t.y);
          T.lineTo(t.x + P / 2, t.y);
          T.lineTo(t.x + P / 2, M);
          T.lineTo(t.x - P / 2, M);
          T.moveTo(t.x - P / 2, t.y);
        }
  ...
  if (v.dataLabel !== false && D === 1) {
    ...
    t.forEach(function (t, e) {
      ...
      r = a.shift();
      var o = t.data;
      var n = getDataPoints(o, i, r, b, P, v, m, D);
      if (t.type !== 'column') {
        drawPointText(n, t, m, T, v);
      } else {
        n = fixColumeData(n, P, F, _, m, v);
        drawPointText(n, t, m, T, v);
        _ += 1;
      }
    });
  ...
  T.restore();
  return { xAxisPoints: b, calPoints: L, eachSpacing: P };
}
...
function drawXAxis(r, l, s, h) {
  ...
  var x = l.height - l.area[2];
  var i = l.area[0];
  if (l.enableScroll && l.xAxis.scrollShow) {
    var o = l.height - l.area[2] + s.xAxisHeight;
    var n = a - e;
    var g = d * (c.length - 1);
    if (
      l.type == 'mount' &&
  ...
  if (l.xAxis.disabled !== true) {
    ...
    a[i - 1] = r[i - 1];
    var f = l.xAxis.fontSize * l.pix || s.fontSize;
    if (s._xAxisTextAngle_ === 0) {
      a.forEach(function (t, e) {
        var a = l.xAxis.formatter ? l.xAxis.formatter(t, e, l) : t;
        var i = -measureText(String(a), f, h) / 2;
        if (p == 'center') {
          i += d / 2;
        }
        var r = 0;
        ...
        h.fillText(String(a), c[e] + i, x + f + (s.xAxisHeight - r - f) / 2);
        h.closePath();
        h.stroke();
      });
    } else {
      a.forEach(function (t, e) {
        var a = l.xAxis.formatter ? l.xAxis.formatter(t) : t;
        h.save();
        h.beginPath();
        h.setFontSize(f);
        h.setFillStyle(l.xAxis.fontColor || l.fontColor);
        var i = measureText(String(a), f, h);
        var r = c[e];
        if (p == 'center') {
          r = c[e] + d / 2;
        }
        ...
        var n = x + 6 * l.pix + f - f * Math.abs(Math.sin(s._xAxisTextAngle_));
...
function drawYAxis(e, h, a, c) {
  ...
  var l = h.height - h.area[2];
  var t = l + a.xAxisHeight;
...
function drawLegend(t, l, y, s, e) {
  ...
  let f = 15 * l.pix;
  let p = 5 * l.pix;
  let g = l.legend.itemGap * l.pix;
  let u = Math.max(l.legend.lineHeight * l.pix, x);
  s.beginPath();
  ...
  a.forEach(function (i, t) {
    ...
    for (let a = 0; a < i.length; a++) {
      ...
      switch (t.legendShape) {
        case 'line':
          s.moveTo(r, o + 0.5 * u - 2 * l.pix);
          s.fillRect(r, o + 0.5 * u - 2 * l.pix, 15 * l.pix, 4 * l.pix);
          break;
        case 'triangle':
          s.moveTo(r + 7.5 * l.pix, o + 0.5 * u - 5 * l.pix);
          s.lineTo(r + 2.5 * l.pix, o + 0.5 * u + 5 * l.pix);
          s.lineTo(r + 12.5 * l.pix, o + 0.5 * u + 5 * l.pix);
          s.lineTo(r + 7.5 * l.pix, o + 0.5 * u - 5 * l.pix);
          break;
        case 'diamond':
          s.moveTo(r + 7.5 * l.pix, o + 0.5 * u - 5 * l.pix);
          s.lineTo(r + 2.5 * l.pix, o + 0.5 * u);
          s.lineTo(r + 7.5 * l.pix, o + 0.5 * u + 5 * l.pix);
          s.lineTo(r + 12.5 * l.pix, o + 0.5 * u);
          s.lineTo(r + 7.5 * l.pix, o + 0.5 * u - 5 * l.pix);
          break;
        case 'circle':
          s.moveTo(r + 7.5 * l.pix, o + 0.5 * u);
          s.arc(r + 7.5 * l.pix, o + 0.5 * u, 5 * l.pix, 0, 2 * Math.PI);
          break;
        case 'rect':
          s.moveTo(r, o + 0.5 * u - 5 * l.pix);
          s.fillRect(r, o + 0.5 * u - 5 * l.pix, 15 * l.pix, 10 * l.pix);
          break;
        case 'square':
          s.moveTo(r + 5 * l.pix, o + 0.5 * u - 5 * l.pix);
          s.fillRect(r + 5 * l.pix, o + 0.5 * u - 5 * l.pix, 10 * l.pix, 10 * l.pix);
          break;
        case 'none':
          break;
        default:
      ...
      s.stroke();
      if (l.legend.position == 'top' || l.legend.position == 'bottom') {
        r += measureText(n, x, s) + g;
        t.area[2] = r;
      } else {
        t.area[2] = r + measureText(n, x, s) + g;
        r -= f + p;
        o += u;
      }
    }
...
function drawGaugeDataPoints(n, h, c, t, d) {
  ...
  if (f.type == 'progress') {
    ...
    d.setLineCap('round');
    d.beginPath();
    d.arc(p.x, p.y, u, f.startAngle * Math.PI, f.endAngle * Math.PI, false);
    d.stroke();
    y = f.startAngle - f.endAngle + 1;
    let e = y / f.splitLine.splitNumber;
    let a = y / f.splitLine.splitNumber / f.splitLine.childNumber;
    let i = -g - f.width * 0.5 - f.splitLine.fixRadius;
    let r = -g - f.width - f.splitLine.fixRadius + f.splitLine.width;
    d.save();
    d.translate(p.x, p.y);
    ...
    d.setLineCap('round');
    d.beginPath();
    d.arc(p.x, p.y, u, f.startAngle * Math.PI, h[0]._proportion_ * Math.PI, false);
    d.stroke();
    let l = g - f.width * 2.5;
    d.save();
    d.translate(p.x, p.y);
    ...
    let a = y / f.splitLine.splitNumber / f.splitLine.childNumber;
    let i = -g - f.width * 0.5 - f.splitLine.fixRadius;
    let r = -g - f.width * 0.5 - f.splitLine.fixRadius + f.splitLine.width;
    let o = -g - f.width * 0.5 - f.splitLine.fixRadius + f.splitLine.childWidth;
    d.translate(p.x, p.y);
    d.rotate((f.startAngle - 1) * Math.PI);
  ...
  return { center: p, radius: g, innerRadius: u, categories: n, totalAngle: y };
}
function drawRadarDataPoints(o, n, i, l) {
  ...
  if (s.axisLabel === true) {
    ...
    const g = c / s.gridCount;
    const u = n.fontSize * n.pix;
    l.setFontSize(u);
    ...
    for (var e = 0; e < s.gridCount + 1; e++) {
      ...
      l.fillText(String(t), h.x + 3 * n.pix, h.y - e * g + u / 2);
    }
  }
...
function drawMapDataPoints(c, a, d, i) {
  ...
  var t, o;
  var n = c;
  var l = getBoundingBox(n);
  if (r.mercator) {
    var x = lonlat2mercator(l.xMax, l.yMax);
    var f = lonlat2mercator(l.xMin, l.yMin);
    l.xMax = x[0];
    l.yMax = x[1];
    l.xMin = f[0];
    l.yMin = f[1];
  }
  var p = a.width / Math.abs(l.xMax - l.xMin);
  var g = a.height / Math.abs(l.yMax - l.yMin);
  var s = p < g ? p : g;
  var u = a.width / 2 - (Math.abs(l.xMax - l.xMin) / 2) * s;
  var y = a.height / 2 - (Math.abs(l.yMax - l.yMin) / 2) * s;
  for (var h = 0; h < n.length; h++) {
    ...
    var v = n[h].geometry.coordinates;
  ...
  a.chartData.mapData = { bounds: l, scale: s, xoffset: u, yoffset: y, mercator: r.mercator };
...
function drawFunnelDataPoints(e, a, t, i) {
  let c = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
  let r = assign(
    {},
    {
      type: 'funnel',
  ...
  let o = (a.height - a.area[0] - a.area[2]) / e.length;
  let n = { x: a.area[3] + (a.width - a.area[1] - a.area[3]) / 2, y: a.height - a.area[2] };
  let l = r.activeWidth * a.pix;
  let d = Math.min(
...
uCharts.prototype.dobuleZoom = function (t) {
  ...
  let n = getXAxisPoints(this.opts.categories, this.opts, this.config),
    ...
    p = n.endX,
    l = n.eachSpacing;
  let g = l * this.scrollOption.moveCurrent1;
  let u = p - f;
  let y = u - l * (x.length - 1);
  o = -g + Math.min(i[0].x, i[1].x) - this.opts.area[3] - l;
  if (o > 0) {
    o = 0;
  }
  if (o < y) {
